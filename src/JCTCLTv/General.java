...
public class General extends Programme{
    ...
    public String[] Details() {
        return new String[] {progId, progName, progColour, showDate, showTime, description, Boolean.toString(isNew), null, null, null,null,null,null,null,null, Float.toString(length)};
    }
}
